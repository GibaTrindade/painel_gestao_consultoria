...
urlpatterns = [
    ...
    path("consolidacao/", views.consolidacao_view, name="consolidacao"),
    path("analises/problemas/", views.analise_problemas_view, name="analise-problemas"),
    path("alternar-modo/", views.alternar_modo_view, name="alternar-modo"),
